...
- **Resolve vs Patience.** Chip their **Resolve** (CHA + CON modifier, floor 1 — force of personality + grit) to 0 to **sway** them — they concede / do what you were after, their bond toward you deepens, and you gain a String. If their **Patience** (WIS + CHA modifier, floor 2 — composure + poise) empties first they **walk away** (their agenda advances). Tracks arm themselves on the first maneuver — no setup step. Resolve is kept low on purpose: real weight comes from the maneuver's **school** (General 1 · archetype schools 2 · Humiliate 3), so a smart line breaks even a tough NPC in ~2 heavy hits rather than a stuffy HP grind.
