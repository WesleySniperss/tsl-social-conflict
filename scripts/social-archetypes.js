...
const BOND_TYPES = [
  ...
  { id: "family",   label: "Family",    icon: "fa-house-chimney",   school: "attention", guardDc: -1, guilt: true, combatAura: { label: "Blood shields blood", ac: 1 },  skills: { Insight: 1, Deception: -1 },
  ...
  { id: "crush",    label: "Crush",     icon: "fa-heart-circle-exclamation", school: "attention", guardDc: -1, guilt: false, combatAura: { label: "Showing off", init: 1, ac: -1 }, skills: { Performance: 1, Deception: -1 },
    hint: "Longing. Weapon: +● Emotion. Skills: +● Performance (you shine for them), −● Deception (you're transparent around them). Guard: DC −●." },
  { id: "lover",    label: "Lover",     icon: "fa-heart",           school: "attention", guardDc: -1, guilt: true, combatAura: { label: "Something to lose", ac: 1, attack: -1 },  skills: { Insight: 1, Intimidation: -1 },
  ...
  { id: "mentor",   label: "Mentor",    icon: "fa-graduation-cap",  school: "attention", guardDc: -1, guilt: false, combatAura: { label: "The old lessons", check: 1 }, mirror: "protege",  skills: { Insight: 1, Deception: -1 },
    hint: "They shaped you. Weapon: +● Emotion. Skills: +● Insight, −● Deception (you cannot fool your teacher). Guard: DC −●." },
  { id: "protege",  label: "Protégé",   icon: "fa-seedling",        school: "attention", guardDc: -1, guilt: true, combatAura: { label: "Someone is watching", damage: 1 },  mirror: "mentor",   skills: { Persuasion: 1, Intimidation: -1 },
  ...
  { id: "rival",    label: "Rival",     icon: "fa-khanda",          school: "power",     guardDc: 0,  guilt: false, combatAura: { label: "Blood up", attack: 1, ac: -1 }, skills: { Performance: 1, Deception: -1 },
    hint: "A respected opponent. Weapon: +● Power. Skills: +● Performance (they rise to a show), −● Deception (they have studied your tricks)." },
  { id: "enemy",    label: "Enemy",     icon: "fa-skull",           school: "power",     guardDc: 1,  guilt: false, combatAura: { label: "Tunnel vision", damage: 1, save: -1 }, skills: { Intimidation: 1, Persuasion: -1 },
    hint: "Open hostility. Weapon: +● Power. Skills: +● Intimidation, −● Persuasion — you can't charm hatred, only lean on it. Guard: DC +●." },
  { id: "indebted", label: "Indebted",  icon: "fa-scale-unbalanced", school: "order",    guardDc: -1, guilt: false, combatAura: { label: "Under their eye", save: 1, attack: -1 }, mirror: "creditor", skills: { Persuasion: 1, Intimidation: -1 },
  ...
  { id: "creditor", label: "Creditor",  icon: "fa-scale-unbalanced-flip", school: "order", guardDc: 0, guilt: false, combatAura: { label: "The ledger is yours", init: 1 }, mirror: "indebted", skills: { Intimidation: 1, Deception: -1 },
