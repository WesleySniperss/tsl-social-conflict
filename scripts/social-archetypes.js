...
const BOND_TYPES = [
  ...
  { id: "ally",     label: "Ally",      icon: "fa-handshake",       school: "order",     guardDc: 0,  guilt: false, combatAura: "guard", skills: { Persuasion: 1, Deception: -1 },
    hint: "Shared cause. Weapon: +● Reason. Skills: +● Persuasion (they trust your word), −● Deception (they see your games)." },
  { id: "friend",   label: "Friend",    icon: "fa-mug-hot",         school: "attention", guardDc: -1, guilt: true, combatAura: "guard",  skills: { Persuasion: 1, Intimidation: -1 },
  ...
  { id: "family",   label: "Family",    icon: "fa-house-chimney",   school: "attention", guardDc: -1, guilt: true, combatAura: "guard",  skills: { Insight: 1, Deception: -1 },
  ...
  { id: "crush",    label: "Crush",     icon: "fa-heart-circle-exclamation", school: "attention", guardDc: -1, guilt: false, combatAura: "guard", skills: { Performance: 1, Deception: -1 },
    hint: "Longing. Weapon: +● Emotion. Skills: +● Performance (you shine for them), −● Deception (you're transparent around them). Guard: DC −●." },
  { id: "lover",    label: "Lover",     icon: "fa-heart",           school: "attention", guardDc: -1, guilt: true, combatAura: "guard",  skills: { Insight: 1, Intimidation: -1 },
  ...
  { id: "mentor",   label: "Mentor",    icon: "fa-graduation-cap",  school: "attention", guardDc: -1, guilt: false, combatAura: "guard", mirror: "protege",  skills: { Insight: 1, Deception: -1 },
    hint: "They shaped you. Weapon: +● Emotion. Skills: +● Insight, −● Deception (you cannot fool your teacher). Guard: DC −●." },
  { id: "protege",  label: "Protégé",   icon: "fa-seedling",        school: "attention", guardDc: -1, guilt: true, combatAura: "guard",  mirror: "mentor",   skills: { Persuasion: 1, Intimidation: -1 },
  ...
  { id: "rival",    label: "Rival",     icon: "fa-khanda",          school: "power",     guardDc: 0,  guilt: false, combatAura: "press", skills: { Performance: 1, Deception: -1 },
    hint: "A respected opponent. Weapon: +● Power. Skills: +● Performance (they rise to a show), −● Deception (they have studied your tricks)." },
  { id: "enemy",    label: "Enemy",     icon: "fa-skull",           school: "power",     guardDc: 1,  guilt: false, combatAura: "press", skills: { Intimidation: 1, Persuasion: -1 },
    hint: "Open hostility. Weapon: +● Power. Skills: +● Intimidation, −● Persuasion — you can't charm hatred, only lean on it. Guard: DC +●." },
  { id: "indebted", label: "Indebted",  icon: "fa-scale-unbalanced", school: "order",    guardDc: -1, guilt: false, combatAura: "guard", mirror: "creditor", skills: { Persuasion: 1, Intimidation: -1 },
  ...
  { id: "creditor", label: "Creditor",  icon: "fa-scale-unbalanced-flip", school: "order", guardDc: 0, guilt: false, combatAura: "guard", mirror: "indebted", skills: { Intimidation: 1, Deception: -1 },
