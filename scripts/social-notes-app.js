...
class SocialFencingApp extends _SocialAppBase {
  ...
  _buildCodexTab() {
    ...
    const GLOSSARY = {
      ...
      "support skill": "A SECOND skill that ASSISTS the maneuver's main d20 roll — if you're genuinely capable in it (mod ≥ +2) it grants ADVANTAGE (an expertise die on a5e), never a second flat modifier. E.g. Read Them = Insight, with Investigation lending advantage.",
    ...
    const numbers = `
      <div class="tsl-codex-sub">
        ...
        <div class="tsl-codex-combo"><b>Your roll</b> — a d20 + the move's <b>main skill</b>. Its <b>support skill</b> <b>assists by granting advantage</b> when you're genuinely good at it (mod ≥ +2) — it never adds a second flat modifier — plus any situation bonus. On A5E this opens the system's own check dialog.</div>
