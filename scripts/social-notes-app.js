...
class SocialFencingApp extends _SocialAppBase {
  ...
  _buildCodexTab() {
    ...
    const GLOSSARY = {
      ...
      "swayed": "You WON the exchange — Resolve broken to 0. They concede the point / do the thing you were after (the GM frames it); the bond toward you deepens +1; you gain a String on them; their fencing statuses clear.",
      "walk away": "You LOST the exchange — their Patience emptied to 0. They end it on their terms, the bond cools −1, they gain a String on you, and their own agenda advances.",
