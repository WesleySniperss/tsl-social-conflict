  ...
  _renderHTML(context) {
    ...
    const renderEncounter = (p) => {
      ...
      return `<div class="tsl-enc-tracks">
        <div class="tsl-enc-track" data-tooltip="Resolve — their will. Starts at 3 + CHA modifier (floor 3, no cap) — conviction holds the line. Successful maneuvers chip it, 2 on a vulnerability; break it to 0 → swayed.">
          <span class="tsl-enc-track-label">RES</span>${pips(enc.resolve, enc.maxResolve, "resolve")}
        </div>
        <div class="tsl-enc-track" data-tooltip="Patience — their tolerance. Starts at 4 + WIS modifier (floor 3, no cap) — patience is a Wisdom thing. Failures and triggered immunities burn it; at 0 they walk away.">
